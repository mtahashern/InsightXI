...
try:
    ...
    st.error("Engine components missing.")
...
if uploaded_file:
    with st.spinner("Executing Dual-Team Intelligence Pipeline..."):
        ...
        # Simulate Dual-Team Data (In real usage, YOLO clusters by jersey color)
        ...
        with col2:
            ...
            <div class="recovery-card">
                ...
                <strong>Mitigation Plan:</strong> {protocol['mitigation']}
            </div>
            """, unsafe_allow_html=True)
    ...
    st.info("Upload match footage to begin the Elite Dual-Team analysis.")
